...
@section('content')
    ...
    <div class="postNowPosts">
        ...
        <p>11. There is a page which lists the top 5 most popular ordered dishes in the last 30 days.</p>
    </div>

    <div class="postNowPosts">
        <strong><p>The Uber Eats Clone didn't satisfy the following requirements:</p></strong>
        <p>1. Consumer users can add multiple dishes to a cart, along with viewing the contents in the cart, the cost and can remove any unwanted dishes before purchasing these dishes. Once purchased the cart will be emptied.</p>
        <p>2. Restaurants can view a statistic page which shows the amount of sales made by the restaurant along with the weekly sales for past 12 weeks.</p>
        <p>3. Another user called administrator is created through the seeder. After a new restaurant is registered they can't add or remove dishes from their restaurant until it is approved by the administrator.</p>
    </div>
